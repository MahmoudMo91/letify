...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2024 at 01:20 AM
...
CREATE TABLE `auction` (
  ...
  `current_highest_bid` decimal(18,2) DEFAULT NULL,
  `highest_customer_id` int(11) DEFAULT NULL,
  `lowest_add_bid` int(11) DEFAULT NULL
...
INSERT INTO `auction` (`auction_id`, `product_id`, `start_time`, `end_time`, `starting_bid`, `current_highest_bid`, `highest_customer_id`, `lowest_add_bid`) VALUES
(1, 3, '2024-04-29 01:16:22', '2024-05-12 02:16:22', 800.00, NULL, NULL, 50);
...
(2, 'vm6onjbag5ckl3qsaosjplplct', 21, 'EOS 77D DSLR Camera', 58160.00, 1, 'uploads/6521499b3d.jpg');
...
(2, 'oliver', 'kjl', 'fdsf', 'lnlkj', '123', '21', 'o@gmail.com', '202cb962ac59075b964b07152d234b70');
...
(24, 1, 11, 'Lorem ipsum dolor sit amet sed do eiusmod', 3, 1501.65, 'uploads/4ebef5562f.png', '2018-08-02 00:14:55', 1),
(25, 1, 15, 'Lorem Ipsum is simply', 1, 505.22, 'uploads/d712a37947.png', '2018-08-02 00:15:23', 1),
(26, 1, 15, 'Lorem Ipsum is simply', 1, 505.22, 'uploads/d712a37947.png', '2018-08-02 00:19:13', 1),
...
ALTER TABLE `auction`
  ...
  ADD KEY `highest_customer_id` (`highest_customer_id`);
...
--
ALTER TABLE `auction`
  ADD CONSTRAINT `auction_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `tbl_product` (`productId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `auction_ibfk_2` FOREIGN KEY (`highest_customer_id`) REFERENCES `tbl_customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
